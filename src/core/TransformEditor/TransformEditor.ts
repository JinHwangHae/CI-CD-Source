...
// @ts-ignore
import { destroyObject, Check, knockout, Scene, Matrix4, BoundingSphere } from "cesium";

import TransformEditorViewModel from "./TransformEditorViewModel";
...
class TransformEditor {
    private _viewModel: TransformEditorViewModel;
    ...
    // eslint-disable-next-line class-methods-use-this
    hideMenu() {
        const elements = document.getElementsByClassName("transform-editor-menu");
