import { Cartographic, Cartesian2, Color, defaultValue, Cartesian3 } from "cesium";

import { DimensionLabelTypes, LabelAlignments, setMarginLeftFloat } from "./common";
import { LabelService } from "./LabelService";

function setBorderColor(element: HTMLElement, color: string) {
    element.style.borderColor = `transparent ${color} ${color} transparent`;
}

function getBackgroundColor(options: { showBackground: boolean; opacity: number; backgroundColor: Color }) {
...
interface ConstructorOptions {
    type: DimensionLabelTypes;
    text: string;
    alignment?: LabelAlignments;
    textColor?: Color;
...
export class DimensionLabel {
    private readonly _type: DimensionLabelTypes;
    private _text: string;
    private _alignment: LabelAlignments;
    private _textColor: Color;
    private _backgroundColor: Color;
    private _showBackground: boolean;
    private _opacity: number;
    private _offset: Cartesian2;
    private _fontSize: number;
    private _cesiumPosition: Cartesian3;
    private _adjustZ: number;
    private readonly _selectable: boolean;
    private readonly _showBottomArrow: boolean;
    container: HTMLElement;
    label: HTMLElement | undefined;
    bottomArrow: HTMLElement | undefined;
    labelService: LabelService;
