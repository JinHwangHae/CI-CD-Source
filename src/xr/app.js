...
function init() {
    ...
    let tilesetServer = CONSTRUKTED_AJAX.assets_server;
    let tilesetURL = tilesetServer + "/" + construktedAssetSlug + "/tileset.json";
        ...
        .then(function () {
            ...
            if (!mobile) {
                ...
                cesiumFPVCameraController.FPVStarted().addEventListener(function () {
                    ...
                    if (!mobile) document.querySelector("#debug-ui").style.display = "block";
                });
...
function changeCesiumCamera(translationX, translationY, translationZ, rotationX, rotationY, rotationZ) {
