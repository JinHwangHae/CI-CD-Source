...
const CesiumFVPCameraController = (function () {
    ...
    function CesiumFVPCameraController(options) {
        ...
        this._ignoreCollisionDetection = Cesium.defined(options.ignoreCollisionDetection)
    ...
    CesiumFVPCameraController.prototype._onKeyDown = function (event) {
        ...
        switch (keyCode) {
            ...
            case "A".charCodeAt(0):
                ...
                return;
            case 90: // z
                if (this._main3dTileset) this._main3dTileset.show = !this._main3dTileset.show;
                return;
            default:
                return;
        }
    ...
    CesiumFVPCameraController.prototype._startFPV = function (screenPosition) {
        ...
        if (
            ...
            if (!this._isMobile) alert("Please double click exactly on target 3d tile!");
    ...
    CesiumFVPCameraController.prototype._onClockTick = function (clock) {
        ...
        if (this._isMouseLeftButtonPressed) this._changeCameraHeadingPitchByMouse(dt);
