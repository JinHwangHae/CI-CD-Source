...
function init() {
    ...
    customEventTarget.addEventListener("viewerPoseUpdatedEvent", function (e) {
        ...
        //Update Rotation:
        rotXElement.innerHTML = "x: " + fixedSize_JS(Math.floor(e.detail.rotX).toString(), 4) + "&#176;";
        rotYElement.innerHTML = "y: " + fixedSize_JS(Math.floor(e.detail.rotY).toString(), 4) + "&#176;";
        rotZElement.innerHTML = "z: " + fixedSize_JS(Math.floor(e.detail.rotZ).toString(), 4) + "&#176;";
    });
}
